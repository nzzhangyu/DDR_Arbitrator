...
// Simulation-only replacement for the Xilinx ddr4_1200m MIG IP.
// Compile this file for fast mock regressions, and compile the real MIG
...
module ddr4_1200m (
   ...
   assign c0_ddr4_reset_n   = c0_ddr4_aresetn;
